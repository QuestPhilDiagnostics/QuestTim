...
<div class="container" style="margin-top: 10px;">
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
							...
							<td nowrap> 
								<button type="button" class="btn btn-primary" onclick="document.location = 'PExamVIEW.php?id=<?php echo $patient['id']?>';">VIEW RECORD</button>
								<button type="button" class="btn btn-primary" onclick="document.location = 'PExamADD.php?id=<?php echo $patient['id']?>';">ADD RECORD</button>
							</td>
