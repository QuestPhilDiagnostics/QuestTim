    ...
    <div class="col-md-10 offset-sm-1">
        <div class="card" style="border-radius: 0px; margin-top: 10px;">
            ...
            <div class="row">
					...
					<input type="hidden" id="trans" value="<?php echo $data['trans_type'] ?>">
			</div>
			<div class="row">
				<div class="col"></div>
				<div class="col">
...
<script language="javascript"> 
	...
	if(confirm("Are you sure want to print?"))
		{ 
			if (document.getElementById("trans").value == "CASH") 
			{
				win = window.open("ReprintReceiptCASH.php?id=<?php echo $data['id'] ?>");
			}
			else if (document.getElementById("trans").value == "ACCOUNT") 
			{
				win = window.open("ReprintReceiptACCOUNT.php?id=<?php echo $data['id'] ?>");
			}
