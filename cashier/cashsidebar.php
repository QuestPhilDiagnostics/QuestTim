...
<nav class="navbar navbar-toggleable-md navbar-dark navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="TransactionList.php" style="border-right: solid #7f8c8d 3px;">Transaction List</a>
      <a class="nav-item nav-link" href="HMO.php" style="border-right: solid #7f8c8d 3px;">HMO Record</a>
      <a class="nav-item nav-link" href="Package.php" style="border-right: solid #7f8c8d 3px;">Manage Tests Packages</a>
      <a class="nav-item nav-link" href="SalesReport.php" style="border-right: solid #7f8c8d 3px;">Sales Report</a>
    </div>
  </div>
