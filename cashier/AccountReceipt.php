...
<div class="container-fluid">
	<div class="col-5">
		...
		<br>
		<div class="row">
			<div class="col"><b class="info" style="font-size: 16px;"><?php echo $data['lasnam'] ?>, <?php echo $data['firnam'] ?> <?php echo $data['midnam'] ?></b></div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col"><b class="info"><?php echo $data['connum'] ?></b></div>
		</div>
		<?php 
		if ($data['reff']=="") {
