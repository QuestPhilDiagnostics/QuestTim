...
<nav class="navbar navbar-toggleable-md navbar-dark navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="LABSummary.php" style="border-right: solid #7f8c8d 3px;">Lab Summary</a>
      <a class="nav-item nav-link" href="LabSections.php" style="border-right: solid #7f8c8d 3px;">Laboratory Sections</a>
      <a class="nav-item nav-link" href="ResSections.php" style="border-right: solid #7f8c8d 3px;">Result Sections</a>
    </div>
  </div>
