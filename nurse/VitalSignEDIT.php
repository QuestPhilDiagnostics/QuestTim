           	...
           	<form action="VitalSignsUPDATE.php" method="post" autocomplete="off" enctype="multipart/form-data">
            	<div class="row">
					<div class="col-4">
						...
						<input type="hidden" name="id" value="<?php echo $vit['id'] ?>">
						<b><?php echo $vit['id'] ?></b>
					</div>
					<div class="col-4">
						<label>Name:</label><br>
						<input type="hidden" name="lasnam" value="<?php echo $vit['lasnam'] ?>">
						<input type="hidden" name="firnam" value="<?php echo $vit['firnam'] ?>">
						<input type="hidden" name="midnam" value="<?php echo $vit['midnam'] ?>">
						<p><b><?php echo $vit['lasnam'] ?>,<?php echo $vit['firnam'] ?> <?php echo $vit['midnam'] ?></b></p>
					</div>
					<div class="col-4">
						<label>Company Name: </label><br>
						<input type="hidden" name="comnam" value="<?php echo $vit['comnam'] ?>">
