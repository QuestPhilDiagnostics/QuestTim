...
$sql="UPDATE qpd_vital SET height='$height', weight='$weight', bmi='$bmi', bp='$bp', pr='$pr', rr='$rr', uod='$uod', uos='$uos', cod='$cod', cos='$cos', cv='$cv', hearing='$hearing', hosp='$hosp', opr='$opr', pm='$pm', smoker='$smoker', ad='$ad', lmp='$lmp', notes='$notes', date='$date' WHERE id ='$id' ";
