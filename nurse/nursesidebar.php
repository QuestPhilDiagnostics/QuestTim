...
<nav class="navbar navbar-toggleable-md navbar-dark navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="index.php" style="border-right: solid #7f8c8d 3px;border-left: solid #7f8c8d 3px;">Home <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="ListOfPatients.php" style="border-right: solid #7f8c8d 3px;">Summary</a>
      <a class="nav-item nav-link" href="MHVS.php" style="border-right: solid #7f8c8d 3px;">MH & VS</a>
      <a class="nav-item nav-link" href="Registration.php" style="border-right: solid #7f8c8d 3px;">Registration</a>
      <a class="nav-item nav-link" href="PatientInfo.php" style="border-right: solid #7f8c8d 3px;">Patient Info</a>
