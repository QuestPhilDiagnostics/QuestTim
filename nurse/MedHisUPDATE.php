...
$std=isset($_POST['std']) ? $_POST['std'] : "NO";
    ...
    $sqlupdate="UPDATE qpd_medhis SET asth='$asth', tb='$tb', dia='$dia', hb='$hb', hp='$hp', kp='$kp', ab='$ab', jbs='$jbs', pp='$pp', mh='$mh', fs='$fs', alle='$alle', ct='$ct', hep='$hep', std='$std', date='$date'  WHERE id ='$id' ";
