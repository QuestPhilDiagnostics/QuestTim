           	...
           	<form action="MedHisUPDATE.php" method="post" autocomplete="off" enctype="multipart/form-data">
            	<div class="row">
					<div class="col-4">
						...
						<input type="hidden" name="id" value="<?php echo $his['id'] ?>">
						<b><?php echo $his['id'] ?></b>
					</div>
					<div class="col-4">
						<label>Name:</label><br>
						<input type="hidden" name="lasnam" value="<?php echo $his['lasnam'] ?>">
						<input type="hidden" name="firnam" value="<?php echo $his['firnam'] ?>">
						<input type="hidden" name="midnam" value="<?php echo $his['midnam'] ?>">
						<p><b><?php echo $his['lasnam'] ?>,<?php echo $his['firnam'] ?> <?php echo $his['midnam'] ?></b></p>
					</div>
					<div class="col-4">
						<label>Company Name: </label><br>
						<input type="hidden" name="comnam" value="<?php echo $data['comnam'] ?>">
						<p><b><?php echo $his['comnam'] ?></b></p>
					</div>
				</div>
            </div>
        </div>
